...
export default function CartCheckoutForm({
  ...
  useEffect(() => {
    ...
    try {
      ...
      const savedPaymentMethod =
        draft.paymentMethod === "TRANSFER" || draft.paymentMethod === "COD"
          ? draft.paymentMethod
          : "";
  ...
  const adjustment = useMemo(() => {
    if (paymentMethod === "TRANSFER") {
      const value = subtotal * 0.02;

      return {
        label: "Potongan Transfer 2%",
        value: -value,
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      {item.product?.pcsPerBal &&
                      item.quantity >= item.product.pcsPerBal ? (
                        <p className="text-sm text-slate-500">
